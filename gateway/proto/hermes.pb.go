...
func (x *Login) GetEventName() string {
	if x != nil {
		return x.EventName
	}
	return ""
...
var file_hermes_proto_rawDesc = []byte{
	0x0a, 0x0c, 0x68, 0x65, 0x72, 0x6d, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3b,
	...
	0x52, 0x09, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x2c, 0x0a, 0x06, 0x50,
	0x6c, 0x61, 0x79, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x7a, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x74, 0x7a, 0x22, 0x53, 0x0a, 0x09, 0x54, 0x69, 0x6d,
	0x65, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	,
...
var file_hermes_proto_depIdxs = []int32{
	...
	0, // 2: Gateway.GetTimeranges:input_type -> Login
	2, // 3: Gateway.SetTimerange:input_type -> Timerange
	1, // 4: Gateway.GetPlayer:output_type -> Player
	3, // 5: Gateway.GetTimeranges:output_type -> Timeranges
	4, // 6: Gateway.SetTimerange:output_type -> Empty
...
type GatewayClient interface {
	...
	SetTimerange(ctx context.Context, in *Timerange, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *gatewayClient) SetTimerange(ctx context.Context, in *Timerange, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/Gateway/SetTimerange", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GatewayServer interface {
	...
	SetTimerange(context.Context, *Timerange) (*Empty, error)
}
...
func (*UnimplementedGatewayServer) SetTimerange(context.Context, *Timerange) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SetTimerange not implemented")
}
...
func _Gateway_SetTimerange_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Timerange)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GatewayServer).SetTimerange(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Gateway/SetTimerange",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GatewayServer).SetTimerange(ctx, req.(*Timerange))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Gateway_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetTimerange",
			Handler:    _Gateway_SetTimerange_Handler,
		},
	},
