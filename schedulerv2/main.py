...
class EventDb(hermes_pb2_grpc.EventDb):
    ...
    def GetMagicToken(self, request, context):
        ...
        self.session.query(Player).filter(Player.player_dc_id == request.player_dc_id).update(
    ...
    def GetEvents(self, request, context):
        ...
        events_list = []
        for event in events:
            events_list.append(hermes_pb2.EventInfo(
    ...
    def GetEventPlayers(self, request, context):
        ...
        for player_dc_id, timeranges in players.items():
            ...
            for timerange in timeranges:
                timeranges_response.append(hermes_pb2.Timerange(
